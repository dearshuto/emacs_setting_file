...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet which-key use-package undo-tree symbol-overlay rustic rainbow-mode rainbow-delimiters lsp-ui leaf json-mode flycheck exec-path-from-shell eglot doom-themes doom-modeline dap-mode csproj-mode csharp-mode counsel company-lua company-glsl company-box cmake-mode cargo))
